...
namespace Startcode\ValueObject\Constants;
...
class Timezones
{
    ...
    public const ZONES = [
        ...
        'America/Ojinaga' => '(GMT-6:00) America/Ojinaga (Mountain Daylight Time)',
        ...
        'Asia/Hebron' => '(GMT+3:00) Asia/Hebron (Eastern European Summer Time)',
        ...
        'Asia/Yangon' => '(GMT+6:30) Asia/Yangon (Myanmar Time)',
