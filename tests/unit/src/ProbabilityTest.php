...
use Startcode\ValueObject\{Probability, Dictionary};
use Startcode\ValueObject\Exception\{InvalidProbabilityOutcomeException, InvalidProbabilityException};
...
class ProbabilityTest extends \PHPUnit\Framework\TestCase
{
    ...
    public function testAcrossBoundariesLOW() : void
    {
        $this->expectException(InvalidProbabilityException::class);
        $this->expectExceptionMessage('Probability -1 is invalid');
        $this->expectExceptionCode(60024);
        (new Probability(-1));
    }

    public function testAcrossBoundariesHIGH() : void
    {
        $this->expectException(InvalidProbabilityException::class);
        $this->expectExceptionMessage('Probability 101 is invalid');
        $this->expectExceptionCode(60024);
        (new Probability(101));
    }
    ...
    public function testInvalidOutcome() : void
    {
